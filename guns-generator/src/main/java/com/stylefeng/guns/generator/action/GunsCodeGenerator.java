...
/**
 * 代码生成器,可以生成实体,dao,com.stylefeng.guns.core.persistence.service,controller,html,js
 *
 * @author stylefeng
...
public class GunsCodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Mybatis-Plus的代码生成器:
         *      mp的代码生成器可以生成实体,mapper,mapper对应的xml,com.stylefeng.guns.core.persistence.service
         */
