...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add(contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName() + ".com.stylefeng.guns.rest.persistence.service.I" + contextConfig.getBizEnBigName() + "Service");
        ...
        this.servicePathTemplate = "\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\modular\\" + contextConfig.getModuleName() + "\\com.stylefeng.guns.rest.persistence.service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\modular\\" + contextConfig.getModuleName() + "\\com.stylefeng.guns.rest.persistence.service\\impl\\{}ServiceImpl.java";
        this.packageName = contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName() + ".com.stylefeng.guns.rest.persistence.service";
    }
