...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.baomidou.mybatisplus.com.stylefeng.guns.core.persistence.service.impl.ServiceImpl");
        ...
        imports.add(contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName() + ".com.stylefeng.guns.core.persistence.service.I" + contextConfig.getBizEnBigName() + "Service");
        this.serviceImplImports = imports;

        ArrayList<String> interfaceImports = new ArrayList<>();
        interfaceImports.add("com.baomidou.mybatisplus.com.stylefeng.guns.core.persistence.service.IService");
        ...
        this.servicePathTemplate = "\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\modular\\" + contextConfig.getModuleName() + "\\com.stylefeng.guns.core.persistence.service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\" + contextConfig.getProPackage().replaceAll("\\.", "\\\\") + "\\modular\\" + contextConfig.getModuleName() + "\\com.stylefeng.guns.core.persistence.service\\impl\\{}ServiceImpl.java";
        this.packageName = contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName() + ".com.stylefeng.guns.core.persistence.service";
    }
